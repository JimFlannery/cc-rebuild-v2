...
CREATE TABLE IF NOT EXISTS Orders (
  ...
  SSTMPriceAtCreation      DECIMAL(18,8)  NULL     COMMENT 'SSTM price in USD at order creation; used for tier calculations',
  ...
  IsCommunityOrder         TINYINT(1)     NULL     DEFAULT 0 COMMENT '1 = community pool Yield Boost order',
  CoverageSought           DECIMAL(18,8)  NULL     COMMENT 'Total coverage the community order is seeking (USD)',
  CoverageFilled           DECIMAL(18,8)  NULL     DEFAULT 0 COMMENT 'Coverage filled so far by participants (USD)',
  owner                    VARCHAR(255)   NULL,
  createdAt                DATETIME       NOT NULL,
  updatedAt                DATETIME       NOT NULL,
  PRIMARY KEY (id)
